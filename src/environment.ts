const variables = {
  GITHUB_ORANIZATION_NAME: 'Postdoglab',
  GITHUB_PROJECT_NAME: 'POSTDOG'
};
export const COMMON_APP_CONFIG = {
  // EXTENSION_URL: 'http://localhost:5000',
  EXTENSION_URL: 'https://extensions.POSTDOG.com',
  REMOTE_SOCKET_URL: 'wss://POSTDOG.com',
  // SOCKET_PORT: '',
  ...
  BASE_DOWNLOAD_URL: 'https://data.POSTDOG.com/download/'
