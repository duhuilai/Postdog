...
class webPlatformBuilder {
  ...
  resetBuildConfig(json) {
    delete json.projects.POSTDOG.i18n.sourceLocale.baseHref;
    Object.keys(json.projects.POSTDOG.i18n.locales).forEach(val => {
      delete json.projects.POSTDOG.i18n.locales[val].baseHref;
    });
    return json;
  }
  executeBuild() {
    ...
    <html>
      <head>
        <meta charset="utf-8" />
        <title>POSTDOG - Easy &amp; Open Source API Ecosystem</title>
        <script>
...
class appPlatformBuilder {
  resetBuildConfig(json) {
    json.projects.POSTDOG.i18n.sourceLocale.baseHref = '';
    Object.keys(json.projects.POSTDOG.i18n.locales).forEach(val => {
      json.projects.POSTDOG.i18n.locales[val].baseHref = '';
    });
    return json;
  }
  executeBuild() {
