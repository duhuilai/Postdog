...
const actionComponent = {
  ...
  docExport: ApiDocExportComponent
};
@Component({
...
export class ProjectSettingComponent implements OnInit {
  ...
  overviewList = [
    ...
    },
    {
      ...
      icon: 'efferent',
      desc: $localize`Export POSTDOG project data`,
      type: 'export',
      traceID: 'click_export_project'
    },
    {
      title: $localize`Export API Docs`,
      icon: 'efferent',
      desc: $localize`Export API documentation as Word or PDF`,
      type: 'docExport',
      traceID: 'click_export_api_docs'
    },
    {
